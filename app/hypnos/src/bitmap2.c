...
#ifndef LV_ATTRIBUTE_IMG_BITMAP2
#define LV_ATTRIBUTE_IMG_BITMAP2
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BITMAP2 uint8_t bitmap2_map[] = {
  0x0c, 0xca, 0xfc, 0xff, 	/*Color of index 0*/
