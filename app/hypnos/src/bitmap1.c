...
#ifndef LV_ATTRIBUTE_IMG_BITMAP1
#define LV_ATTRIBUTE_IMG_BITMAP1
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_IMG_BITMAP1 uint8_t bitmap1_map[] = {
